...
;;The ULA bug which causes snow when I is set to point to
;contended memory still occurs, and also appears to crash
;the machine shortly after I is set to point to contended memory.
